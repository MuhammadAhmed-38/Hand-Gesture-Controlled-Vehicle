...
├── Gestures/ # Gesture logic and related files
├── Rain_Sensor/ # Rain sensor and wiper control
├── Results_Images/ # Experimental results and hardware images
├── Simulation_Video/ # Demonstration video
├── FYP_RunningCode.txt # Transmitter and receiver logic
├── New_code.txt # Supporting code
├── RCV_Thesis.pdf # Full thesis documentation
├── RCV_External_Presentation__RCV.pptx
├── RCV_External_Presentation_RCV.pdf
└── README.md
...
**▶ ️ Vehicle Movement Demonstratio**
[Click here to watch the full demo](Simulation_Video/Vehicle_Movement.mp4)

**▶ ️ Complete System Demonstratio**
[Click here to watch the full demo](Simulation_Video/Complete.mp4)
